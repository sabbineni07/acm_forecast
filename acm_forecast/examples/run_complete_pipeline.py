...
def main():
    ...
    try:
        ...
        training_pipeline = TrainingPipeline(config, spark)
        ...
        forecast_pipeline = ForecastPipeline(config, spark)
        
        # Generate forecasts
        horizons = config.forecast.forecast_horizons_days or [30, 90, 180, 365]
