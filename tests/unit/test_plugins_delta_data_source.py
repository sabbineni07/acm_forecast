"""
Unit tests for DeltaDataSource plugin
"""
import pytest
...
class TestDeltaDataSourcePlugin:
    """Unit tests for DeltaDataSource plugin"""
    
    @pytest.mark.unit
    def test_delta_data_source_initialization(self, sample_app_config, spark_session):
        """Test DeltaDataSource initialization"""
